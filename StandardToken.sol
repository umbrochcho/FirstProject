 ...
 */
contract StandardToken is ERC20, MintableToken {
   ...
   */
  function approve(address _spender, uint256 _value) public whenNotPaused whenTokenNormal returns (bool) {
   ...
   */
  function increaseApproval(address _spender, uint _addedValue) public whenNotPaused whenTokenNormal returns (bool) {
    allowed[msg.sender][_spender] = allowed[msg.sender][_spender].add(_addedValue);
    Approval(msg.sender, _spender, allowed[msg.sender][_spender]);
    return true;
  }

  function decreaseApproval(address _spender, uint _subtractedValue) public whenNotPaused whenTokenNormal returns (bool) {
